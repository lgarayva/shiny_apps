...
El siguiente documento muestra de manera ilustrativa el contenido del tablero iteractivo generado por el código ```GEDA_shiny.R```. A manera de ejemplo de utiliza el conjunto de datos *Iris* el cual consta de 150 datos.
